...
export default function useWidgetData(id: string): [WidgetData, (newWidgetData: WidgetData) => void] {
	const widgetData: WidgetData | undefined = useSelector((state: RootState) => selectWidgetById(state, id));
